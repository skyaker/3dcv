...
class VisualOdometry():
    def __init__(self, data_dir):
        ...
        FLANN_INDEX_LSH = 6
        index_params = dict(algorithm=FLANN_INDEX_LSH, table_number=15, key_size=12, multi_probe_level=1)
    ...
    def _load_images(filepath):
        ...
        video_name_list = [video for video in video_name_list if video.find(".mp4") > 0]
